...
# parser.add_argument('--model', default='results/cub/resnet50-87.45/model_best.pth', type=str, metavar='PATH', help='path to model (default: none)')
...
parser.add_argument('--config', default='configs/cub_resnet50.yml', type=str, help='config files')
...
parser.add_argument('--part_images_false', default='results/cub/resnet50-87.45/patches_false/', type=str)
parser.add_argument('--part_images_true', default='results/cub/resnet50-87.45/patches_true/', type=str)
